...
export default function Page() {
  return <main className="container legal-page">
    ...
    <div className="contact-cards">
      ...
      <section className="contact-card"><CalendarClock size={25} /><h2>Vous voulez arrêter votre abonnement ?</h2><p>Vous le résiliez en deux clics depuis votre dossier : aucun nouveau prélèvement, et l’accès continue jusqu’à la fin de la période payée.</p><Link className="button button-secondary" href="/espace">Ouvrir mon espace <ArrowUpRight size={15} /></Link></section>
    </div>
