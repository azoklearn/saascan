...
const items = [
  ...
  ["Comment fonctionne l’abonnement ?", "Vous choisissez une formule de 1, 3 ou 12 mois, renouvelée automatiquement jusqu’à sa résiliation. Votre dossier reste accessible tant que l’abonnement est actif, et les formules 3 et 12 mois ajoutent des idées de vidéos marketing. Vous résiliez en deux clics depuis votre dossier : aucun nouveau prélèvement, et l’accès continue jusqu’à la fin de la période payée. Le premier paiement reste remboursable pendant 48 heures."],
  ["Faut-il créer un compte ?", "Non. Vous répondez au questionnaire sans inscription, puis vous payez sur Whop. Votre dossier s’ouvre ensuite directement, avec un lien personnel à garder : copiez-le ou ajoutez-le à vos favoris. Sur l’appareil utilisé pour le paiement, il reste aussi dans le menu « Mon dossier »."],
];
