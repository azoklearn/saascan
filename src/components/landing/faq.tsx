...
const items = [
  ...
  ["Faut-il créer un compte ?", "Non. Vous répondez au questionnaire sans inscription, puis vous payez sur Whop avec votre email. Votre dossier s’ouvre ensuite directement et un lien personnel vous est envoyé par email pour le retrouver quand vous voulez."],
];
